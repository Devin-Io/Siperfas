/* ===================================================================
   SIPERFAS — Sistem Pengajuan Perbaikan Fasilitas Kampus
   JavaScript / jQuery
   =================================================================== */
...
// Data simulasi awal — supaya halaman Daftar Pengajuan tidak kosong
// saat pertama kali dibuka oleh pengguna baru.
const SEED_DATA = [
  {
    id: 'LPR-2026-001',
...
// =========================================================
// TOAST NOTIFICATION (jQuery animation)
// =========================================================
...
function showToast(type, title, message, duration = 4000) {
  ...
  // Auto-dismiss with slide-up + fade-out
  setTimeout(() => {
...
// =========================================================
// NAVBAR — Active link highlight & scroll shadow
// =========================================================
...
function initNavbar() {
  ...
  // Add shadow on scroll (jQuery scroll event)
...
function initScrollAnimations() {
  ...
  // Stagger animation delay using jQuery
...
// =========================================================
// FORM PENGAJUAN — Validation & Submit
// =========================================================
...
function initPengajuanForm() {
  ...
  // Real-time validation: remove invalid state on input
  $form.find('.form-control, .form-select').on('input change', function() {
    $(this).removeClass('is-invalid');
  });

  // Auto-update Program Studi based on Fakultas selection
  ...
  $form.on('submit', function(e) {
    ...
    // NIM must be numeric & length check
    ...
    if (!valid) {
      ...
      // Smooth scroll to first invalid field (jQuery)
    ...
    // Loading state simulation (jQuery)
  ...
  // Reset button — extra confirmation
...
// =========================================================
// HALAMAN DAFTAR PENGAJUAN — Render, Filter, Search
// =========================================================
...
function initDaftarPage() {
  ...
  // Chip filter clicks (jQuery delegation)
...
// =========================================================
// HOMEPAGE — Animated stats counter (jQuery)
// =========================================================
...
$(document).ready(function() {
  ...
  // Optional welcome toast on first visit
